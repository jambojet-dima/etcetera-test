...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Home Full', 'understrap' ),
				'id'            => 'homefull',
				'description'   => __( 'Full sized home widget', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="home-widget %2$s dynamic-classes">',
				'after_widget'  => '</div><!-- .home-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
		);
